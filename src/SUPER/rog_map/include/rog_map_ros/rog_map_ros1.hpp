...
namespace rog_map {
    ...
    class ROGMapROS :public ROGMap {
        ...
        void cloudCallback(const sensor_msgs::PointCloud2ConstPtr& cloud_msg) {
            ...
            pcl::toROSMsg(tmp_pc, converted_cloud_msg);
            converted_cloud_msg.header.stamp = ros::Time::now();
            converted_cloud_msg.header.frame_id = "world";
            vm_.converted_cloud_pub.publish(converted_cloud_msg);
            //modified end
    ...
    public:
        ...
        ROGMapROS(const ros::NodeHandle& nh, const std::string& cfg_path) :nh_(nh){
            ...
            if (cfg_.visualization_en) {
                ...
                vm_.converted_cloud_pub = nh_.advertise<sensor_msgs::PointCloud2>("rog_map/converted_cloud", 1);
            }
            //Modified here
